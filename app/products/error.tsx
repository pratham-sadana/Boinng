  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-boinng-bg px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-bold mb-2 text-boinng-black">Product Not Found</h2>
        <p className="text-black/60 mb-8">
          The product you're looking for doesn't exist or there was an issue loading it.
        </p>
